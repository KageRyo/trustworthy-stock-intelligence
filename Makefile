...
DATABASE_URL ?= postgresql://tsi:tsi_local_password@localhost:5432/tsi
...
.PHONY: download-tickers ingest-market-data predict-latest predict-latest-baseline api dashboard stock-dashboard frontend-install frontend-build test-python test-go lint test-all
