...
These artifacts are intentionally excluded from git because they can be large and may be
vendor-adjusted over time. Downloader metadata includes SHA-256 fingerprints so an experiment can
identify the exact input snapshot.
